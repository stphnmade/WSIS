...
def _city(
    ...
    *,
    ...
    return CityMetrics(
        ...
        fair_market_rent=median_rent,
        fair_market_rent_source="test_fixture",
        fair_market_rent_source_date="2026-01-01",
        ...
        median_income=90000,
        education_bachelors_pct=45,
        mean_commute_minutes=25,
        job_growth_pct=2.5,
        ...
        is_warm=avg_temp_f >= 65,
        is_affordable=median_rent <= 1800,
        is_high_income=True,
